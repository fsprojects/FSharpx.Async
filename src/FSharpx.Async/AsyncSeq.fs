...
module AsyncSeq = 
  ...
  /// </summary>
  /// <param name="compare">
  /// The compare function should return a signed integer that indicates the 
  /// relative values of the first and second values, following the rules: less
  /// than zero if the first is less than the second; zero if the first equals
  /// the second; greater than zero if the first is greater than the second.
  /// </param>
  let interleaveWith compare (inputA : AsyncSeq<_>) (inputB : AsyncSeq<_>) : AsyncSeq<_> =
